...
import { JiraStory, TaskStatus } from '../types';
...
export default function DeveloperDashboard() {
    ...
    function handleStatusChange(storyId: string, newStatus: TaskStatus) {
        const s = state.jiraStories.find(x => x.id === storyId);
        if (s) dispatch({ type: 'UPDATE_STORY', payload: { ...s, status: newStatus } });
    }
