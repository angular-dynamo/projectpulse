...
export default function DirectorDashboard() {
    ...
    async function handleApprove(reportId: string) {
        ...
        const updated = { ...r, status: 'approved' as const, approvedBy: 'David Park', approvalComment: '', updatedAt: new Date().toISOString() };
        ...
        try {
            ...
            setToastMsg('Failed to approve report on server');
        }
    }

    async function handleReject(reportId: string) {
        const r = state.weeklyReports.find(x => x.id === reportId)!;
        const updated = { ...r, status: 'rejected' as const, approvedBy: 'David Park', approvalComment: commentMap[reportId] ?? 'Please revise and resubmit.', updatedAt: new Date().toISOString() };
        ...
        try {
            ...
            setToastMsg('Failed to reject report on server');
        }
    }
